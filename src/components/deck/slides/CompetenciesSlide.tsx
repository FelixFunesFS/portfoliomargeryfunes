...
const competencies = [
  { name: 'UX Research', icon: Search, years: 8, metric: '15+ studies', color: 'hsl(215,85%,55%)' },
  { name: 'Systems Analysis', icon: Layers, years: 10, metric: '10k+ users', color: 'hsl(215,85%,35%)' },
  { name: 'UI/UX Design', icon: Palette, years: 6, metric: '8+ apps', color: 'hsl(25,90%,55%)' },
  { name: 'Data Analysis', icon: BarChart3, years: 8, metric: '500+ hours', color: 'hsl(190,75%,45%)' },
  { name: 'Strategic Planning', icon: Target, years: 10, metric: 'Multi-year roadmaps', color: 'hsl(262,83%,65%)' },
  { name: 'Leadership', icon: Users, years: 12, metric: '50+ personnel', color: 'hsl(140,50%,55%)' },
];
