              ...
              <CollapsibleTrigger className="w-full group">
                <div className="flex items-center justify-between w-full hover:bg-amber-500/5 transition-colors rounded-lg p-3">
                  <div className="flex items-center gap-2 text-amber-600 dark:text-amber-400">
                    ...
                    <h4 className="font-semibold text-sm md:text-base uppercase tracking-wider">Growth & Lessons Learned</h4>
                  </div>
                ...
                <div className="pl-4 grid grid-cols-1 lg:grid-cols-2 gap-4">
                    ...
                    {caseStudy.reflection.whatWorkedWell && caseStudy.reflection.whatWorkedWell.length > 0 && (
                      <div className="space-y-2">
                        <div className="flex items-center gap-2 text-green-600 dark:text-green-400">
                          ...
                          <h5 className="font-semibold text-sm md:text-base uppercase tracking-wide">What Worked Well</h5>
                        </div>
                        <ul className="space-y-1.5 pl-6 text-xs sm:text-sm md:text-base text-muted-foreground">
                    ...
                    {caseStudy.reflection.wouldDoDifferently && caseStudy.reflection.wouldDoDifferently.length > 0 && (
                      <div className="space-y-2">
                        <div className="flex items-center gap-2 text-amber-600 dark:text-amber-400">
                          ...
                          <h5 className="font-semibold text-sm md:text-base uppercase tracking-wide">Future Optimizations</h5>
                        </div>
                        <ul className="space-y-1.5 pl-6 text-xs sm:text-sm md:text-base text-muted-foreground">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-2 text-primary">
                      ...
                      <h5 className="font-semibold text-sm md:text-base uppercase tracking-wide">Key Lesson</h5>
                    </div>
                    <div className="p-4 rounded-lg bg-primary/5 border border-primary/20">
                      <p className="text-sm md:text-base lg:text-lg text-foreground leading-relaxed lg:leading-loose">
              ...
              <CollapsibleTrigger className="w-full group">
                <div className="flex items-center justify-between w-full hover:bg-primary/5 transition-colors rounded-lg p-3">
                  <div className="flex items-center gap-2 text-primary">
                    ...
                    <h4 className="font-semibold text-sm md:text-base uppercase tracking-wider">Research Process & Methodology</h4>
                  </div>
                  <ChevronDown className={cn(
