      ...
      <section className="section gradient-subtle">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {skillsArsenal.map((skillArea, index) => <motion.div key={index} initial={{
            opacity: 0,
            y: 30
          }} whileInView={{
            opacity: 1,
                ...
                <Card className="h-full bg-background/50 border border-border/50 shadow-sm hover:shadow-md transition-all duration-300">
                  ...
                  <CardContent>
                    <div className="space-y-2">
                      {skillArea.skills.map((skill, skillIndex) => <Badge key={skillIndex} variant="secondary" className="text-xs mr-2 mb-2">
                          {skill}
                        </Badge>)}
                    </div>
                  </CardContent>
                ...
                <Card className="bg-background border border-primary/30 shadow-sm">
                  <CardContent className="p-6">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <h4 className="font-semibold text-primary">"I don't just build systems or design interfaces — I create bridges between complex technology and human needs, ensuring solutions are both technically sound and genuinely useful."</h4>
                    </div>
      ...
      <section className="py-16 sm:py-20 bg-gradient-to-br from-primary/5 via-accent/5 to-agile-primary/5">
        <div className="container max-w-4xl mx-auto px-4 text-center">
          ...
          duration: 0.6
            ...
            <Button onClick={() => navigate('/case-studies')} size="lg" className="bg-accent hover:bg-accent/90 text-accent-foreground shadow-lg px-8 py-4">
